...
export default function FileResign({ resign }) {
  ...
  const handlePrevious = () => {
    ...
    router.post(`/dokumen/file-resign/${resign.id}`, formData, {
      onSuccess: () => {
        alert('Form berhasil disubmit dan disimpan!');
        router.visit('/dokumen'); // Redirect ke /dokumen
        setLoading(false);
      },
      onError: (errors) => {
